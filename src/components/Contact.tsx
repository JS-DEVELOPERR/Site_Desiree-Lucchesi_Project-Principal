          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4 mt-6">
                <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-rose-600 dark:hover:text-rose-500 transition-colors">
